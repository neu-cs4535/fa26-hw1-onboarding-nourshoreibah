...
BEGIN
  ...
  ASSERT v_dirty = v_students, format('%s of %s dependent rows enqueued', v_dirty, v_students);
  RAISE NOTICE 'appended %, enqueued % of % rows (public and private)', v_hw1, v_dirty, v_students;
END $$;
